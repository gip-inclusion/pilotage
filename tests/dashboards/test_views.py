...
def test_tableaux_de_bord_publics_without_dashboards(snapshot, client):
    assert str(parse_response_to_soup(client.get(reverse("dashboards:tableaux_de_bord_publics")), selector="#main")) == snapshot()
...
def test_tableau_de_bord_public(snapshot, client):
    ...
    assert str(parse_response_to_soup(client.get(reverse("dashboards:tableau_de_bord_public", kwargs={"slug": dashboard.slug})), selector="#main")) == snapshot()
